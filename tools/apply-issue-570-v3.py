...
# macho.js: one budget created at the thin-image boundary, then threaded through
# every metadata source that can amplify compact bytes into JS objects.
...
# macho-dyld.js: same budget for imports/sites/binds/trie output.
