# Phase 8 — Decompiler Quality Implementation Playbook
...
It is not a substitute for the Master Architecture. If this playbook conflicts with the canonical architecture or a later accepted ADR, the canonical contract wins.
