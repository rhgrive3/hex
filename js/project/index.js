...
export async function importHexProject(input) { if (typeof Blob !== 'undefined' && input instanceof Blob) return parseHexProject(await input.text()); return parseHexProject(input); }
