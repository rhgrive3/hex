...
export class AIRuntime {
  ...
  async turn(input = {}, options = {}) {
    ...
    const externalAbort = () => turnController.abort('cancelled');
    ...
    else await this.sessionStore.update(session.id, { mode: request.mode, style: request.style, scope: request.scope, goal: request.goal });
